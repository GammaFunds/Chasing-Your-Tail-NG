...
HMAC_KEY = b"out-of-bound-unknown-e2e-test-key"
SESSION_CONTROLLER_ID = "e2e_controller"
SESSION_REFERENCE = "out_of_bound_unknown_001"
OBS_SENSOR_ID = "obs_sensor"
GPS_SENSOR_ID = "gps_sensor"
INGEST_TS = 2_000_000
OBS_SOURCE_TS = 1_000_000
FIX_SOURCE_TS = 1_000_501
...
MANIFEST = GroundTruthScenarioManifestV1(
    ...
    scenario_id="cyt.test.out_of_bound_remains_unknown",
    scenario_version="1.0.0",
    scenario_label="Out-of-Bound Fix Remains Unknown Scenario",
    tags=("e2e", "out-of-bound", "unknown"),
    input_manifest_digest=INPUT_MANIFEST_DIGEST,
    expected_summary=EXPECTED_SUMMARY,
)


class TestOutOfBoundFixRemainsUnknownMatchesManifest(unittest.TestCase):
    def setUp(self):
    ...
    def test_out_of_bound_fix_remains_unknown_matches_manifest(self):
        ...
        # --- decode one operator fix (transient, not persisted) ---
        ...
        # --- explicit distance assertion ---
        source_fix_distance = abs(fix.operator_fix_timestamp_us - OBS_SOURCE_TS)
        self.assertEqual(source_fix_distance, 501)
        self.assertEqual(source_fix_distance, CORRELATION_BOUND_US + 1)
