...
MANIFEST = GroundTruthScenarioManifestV1(
    ...
    scenario_id="cyt.test.positive_delta_at_inclusive_bound",
    scenario_version="1.0.0",
    scenario_label="Positive Delta at Inclusive Bound Scenario",
    tags=("e2e", "inclusive-bound"),
    input_manifest_digest=INPUT_MANIFEST_DIGEST,
    expected_summary=EXPECTED_SUMMARY,
)


class TestPositiveDeltaAtInclusiveBoundMatchesManifest(unittest.TestCase):
    def setUp(self):
    ...
    def test_positive_delta_at_inclusive_bound_matches_manifest(self):
