...
HMAC_KEY = b"exact-timestamp-e2e-test-key"
SESSION_CONTROLLER_ID = "e2e_controller"
SESSION_REFERENCE = "exact_ts_001"
...
MANIFEST = GroundTruthScenarioManifestV1(
    ...
    scenario_id="cyt.test.exact_timestamp_completed",
    scenario_version="1.0.0",
    scenario_label="Exact Timestamp Completed Scenario",
    tags=("e2e", "exact-timestamp"),
    input_manifest_digest=INPUT_MANIFEST_DIGEST,
    expected_summary=EXPECTED_SUMMARY,
)


class TestExactTimestampCompletedScenarioMatchesManifest(unittest.TestCase):
    def setUp(self):
    ...
    def test_exact_timestamp_completed_scenario_matches_manifest(self):
